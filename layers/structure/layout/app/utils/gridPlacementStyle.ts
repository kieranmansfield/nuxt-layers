...
export function resolveLayerStyles(layer?: LayerName): PlacementStyle {
  const zIndex = layer ? layerZIndex[layer] : undefined
...
export function buildGridPlacementStyle(input: GridPlacementInput): PlacementStyle {
  ...
  Object.assign(style, resolveLayerStyles(input.layer))
...
export function buildGridPlacementClasses(input: Pick<GridPlacementInput, 'container'>) {
