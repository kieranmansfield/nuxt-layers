...
import type { BlobConfig, AccentSceneConfig } from '../../types/accent'
...
const resolvedBlobs = computed((): BlobConfig[] => {
  ...
  if (props.preset) {
    const scenes = (appConfig.uiLayer as Record<string, unknown> | undefined)?.accentScenes as Record<string, AccentSceneConfig> | undefined
