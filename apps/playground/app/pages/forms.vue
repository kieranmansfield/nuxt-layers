        ...
        <section class="space-y-6">
          ...
          <UCard>
            <template #header>
              ...
              <p class="text-sm text-muted mt-1">Dynamic field rendering based on type prop</p>
            </template>
        ...
        <section class="space-y-6">
          ...
          <UCard>
            <template #header>
              ...
              <p class="text-sm text-muted mt-1">Central registry for field type definitions</p>
            </template>
              ...
              <div class="space-y-4">
                ...
                <div class="space-y-3">
                  ...
                  <div class="p-3 bg-muted dark:bg-accented rounded-lg">
                    ...
                    <p class="text-sm text-toned dark:text-muted">Minimum 8 characters required</p>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div class="grid gap-4 md:grid-cols-2">
                ...
                >
                  ...
                  <ul class="text-sm text-blue-700 dark:text-blue-300 space-y-1">
                    <li>
                      • Use
                      <code class="bg-blue-100 dark:bg-blue-800 px-1 rounded">.pipe()</code>
                      to extend base validation
                    </li>
                    <li>
                ...
                <div class="space-y-3">
                  ...
                  <div class="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p class="text-sm text-muted">Name ≥3 chars, valid email, message ≥8 chars</p>
                    </div>
                  </div>
                  <div class="flex items-start gap-3">
                    <UIcon name="i-lucide-check" class="text-green-500 mt-0.5" />
                  ...
                  <div class="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p class="text-sm text-muted">Resend API via <code>/api/contact</code></p>
                    </div>
                  </div>
                  <div class="flex items-start gap-3">
                    <UIcon name="i-lucide-check" class="text-green-500 mt-0.5" />
              ...
              <div class="flex items-center gap-4">
                ...
                >
                  <div v-if="testEmailResult" class="flex items-center gap-2">
                    <UIcon
                      :name="
                        testEmailResult.success ? 'i-lucide-check-circle' : 'i-lucide-x-circle'
                      "
