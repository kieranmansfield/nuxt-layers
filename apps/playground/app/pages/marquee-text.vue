...
<template>
  ...
  >
    <div>
      ...
      <section class="py-24 bg-default">
        <UContainer>
          <div class="text-center mb-12">
            ...
            <h2 class="text-4xl font-bold text-highlighted mb-3">Single row</h2>
            <p class="text-muted">
      ...
      <section class="py-24 bg-default">
        <UContainer>
          <div class="text-center mb-12">
            ...
            <h2 class="text-4xl font-bold text-highlighted mb-3">Multiple rows</h2>
            <p class="text-muted">
      ...
      <section class="py-24 bg-default">
        <UContainer>
          <div class="text-center mb-16">
            ...
            <h2 class="text-4xl font-bold text-highlighted mb-3">Velocity prop</h2>
            <p class="text-muted">
          ...
          <div class="space-y-12">
            <div>
              <p class="text-center text-muted text-sm font-mono mb-4">velocity: 30 — slow</p>
            ...
            <div>
              <p class="text-center text-muted text-sm font-mono mb-4">velocity: 250 — fast</p>
      ...
      <section class="py-24 bg-default">
        <UContainer>
          <div class="text-center mb-16">
            ...
            <h2 class="text-4xl font-bold text-highlighted mb-3">Damping &amp; stiffness</h2>
      ...
      <section class="py-24 bg-default">
        <UContainer>
          <div class="text-center mb-16">
            ...
            <h2 class="text-4xl font-bold text-highlighted mb-3">Input / output range</h2>
            <p class="text-muted max-w-xl mx-auto">
      ...
      <section class="py-24 bg-default">
        <UContainer>
          <div class="text-center mb-12">
            ...
            <h2 class="text-4xl font-bold text-highlighted mb-3">Pause on hover</h2>
            <p class="text-muted">
      ...
      <!-- ─── Custom styling ────────────────────────────────────────────────── -->
      <section class="py-0 bg-default overflow-hidden">
        <MotionMarqueeText
          :texts="['DARK ON LIGHT ✦', 'INVERTED STYLE ✦']"
          :velocity="80"
          :velocity-mapping="{ input: [0, 500], output: [0, 6] }"
          scroller-class-name="!text-highlighted"
          class-name="!text-highlighted"
        />
      </section>
      ...
      <section class="py-24 bg-default">
        <UContainer>
          <div class="text-center mb-16">
            ...
            <h2 class="text-4xl font-bold text-highlighted mb-3">All together</h2>
            <p class="text-muted">
      ...
      <section class="py-16 bg-default">
        <UContainer>
          <div class="flex flex-col md:flex-row gap-8 items-center justify-between">
            <div>
              <h2 class="text-2xl font-bold text-highlighted mb-2">MotionMarqueeText</h2>
              <p class="text-muted">Velocity-reactive text marquee — motion layer</p>
            </div>
