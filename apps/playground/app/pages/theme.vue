              ...
              <div class="flex rounded-lg overflow-hidden">
                ...
                >
                  <span
                    ...
                    :style="{ color: shade < 500 ? `var(--ui-color-${role.key}-800)` : `var(--ui-color-${role.key}-100)` }"
                  >
                    {{ shade }}
                  </span>
                </div>
          ...
          <div class="grid grid-cols-2 gap-4 sm:grid-cols-4">
            ...
            >
              ...
              <div class="flex flex-col gap-1.5">
                <UButton :color="role.key" size="sm" :label="role.label" class="w-full justify-center" />
            ...
            <UCard :ui="{ body: 'p-4' }">
              <div class="space-y-3">
                ...
                <div class="grid grid-cols-3 gap-3 text-sm">
                  <div class="space-y-1">
                    <p class="text-xs text-muted font-medium uppercase tracking-wide">Media Query</p>
                    <UBadge
                  ...
                  <div class="space-y-1">
                    <p class="text-xs text-muted font-medium uppercase tracking-wide">User Override</p>
                    <UBadge
