        ...
        <section class="space-y-6">
          ...
          <UCard>
            <template #header>
              ...
              <p class="text-muted mt-1 text-sm">
                Sizes: <code class="text-primary">sm</code> · <code class="text-primary">md</code> ·
                <code class="text-primary">lg</code> · <code class="text-primary">xl</code> ·
                <code class="text-primary">full</code>
              </p>
            </template>
            <div class="space-y-4">
              <!-- Size preview -->
