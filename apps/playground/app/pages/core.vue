                    ...
                    <div class="space-y-3">
                      ...
                      <div class="space-y-2">
                        ...
                        <div class="flex flex-wrap gap-1.5 pt-2">
                          <UBadge
                            :color="isMobile ? 'success' : 'neutral'"
                            variant="subtle"
                            size="xs"
                          >
                            Mobile
                          ...
                          <UBadge
                            :color="isTablet ? 'success' : 'neutral'"
                            variant="subtle"
                            size="xs"
                          >
                            Tablet
                          ...
                          <UBadge
                            :color="isDesktop ? 'success' : 'neutral'"
                            variant="subtle"
                            size="xs"
                          >
                            Desktop
                    ...
                    <div class="space-y-3">
                      ...
                      <div class="space-y-2">
                        ...
                        <div class="flex gap-2 pt-2">
                          <UBadge
                            :color="isPortrait ? 'success' : 'neutral'"
                            variant="subtle"
                            size="xs"
                          >
                            Portrait
                          ...
                          <UBadge
                            :color="isLandscape ? 'success' : 'neutral'"
                            variant="subtle"
                            size="xs"
                          >
                            Landscape
