        ...
        <div class="space-y-12 py-8">
          ...
          <UCard v-if="page">
            <template #header>
              ...
              <p class="text-sm text-muted mt-1">
                Rendered markdown with prose theming via
                <code class="text-xs bg-muted/50 px-1.5 py-0.5 rounded">useContentPage()</code>
              </p>
            </template>
          ...
          <section class="space-y-4">
            ...
            <p class="text-sm text-muted">
              Uses
              <code class="text-xs bg-muted/50 px-1.5 py-0.5 rounded">&lt;BlogList /&gt;</code>
              component. Drafts are excluded by default. Click a post to see the detail page with
              surround navigation.
            </p>
          ...
          <section class="space-y-4">
            ...
            <p class="text-sm text-muted">
              Uses
              <code class="text-xs bg-muted/50 px-1.5 py-0.5 rounded">&lt;PortfolioList /&gt;</code>
              component. Filter by featured status, tags, or limit results.
            </p>
            <PortfolioList />
          </section>
          ...
          <section class="space-y-4">
            ...
            <p class="text-sm text-muted">
              Uses
              <code class="text-xs bg-muted/50 px-1.5 py-0.5 rounded">&lt;GalleryGrid /&gt;</code>
              component. Click a collection to view the detail page with lightbox.
            </p>
            <GalleryGrid />
          </section>
          ...
          <UCard>
            ...
            <div class="space-y-3 text-sm">
              <p>
                The content layer includes optional
                <code class="text-xs bg-muted/50 px-1.5 py-0.5 rounded">nuxt-studio</code>
                integration. When installed, it provides a visual editing interface at
                <code class="text-xs bg-muted/50 px-1.5 py-0.5 rounded">/_studio</code> for all
                content collections.
              </p>
              <p>
                Studio auto-discovers your collections (blog, portfolio, gallery) and lets editors
                create and modify content visually — including MDC components like callouts, tabs,
                and cards.
              </p>
              <p class="text-muted">
          ...
          <UCard>
            ...
            <div class="space-y-3 text-sm">
              ...
              <p>
                ...
                <code class="text-xs bg-muted/50 px-1.5 py-0.5 rounded">NuxtContentDetail</code>
                which handles data fetching, SEO meta, surround navigation, and table of contents.
                List components wrap
                <code class="text-xs bg-muted/50 px-1.5 py-0.5 rounded">NuxtContentList</code> for
                consistent loading and empty states.
              </p>
              <p>
                Markdown content supports Nuxt UI's MDC prose components — callouts, tabs, card
                groups, steps, and code groups — which render automatically in both the app and
                Studio editor.
              </p>
            </div>
          </UCard>
