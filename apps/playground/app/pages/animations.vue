  ...
  >
    <div class="bg-gray-950 min-h-screen">
      ...
      <section id="interactive" class="py-24 bg-gray-950">
        <UContainer>
          ...
          <div class="grid md:grid-cols-2 gap-8 mb-16">
            <div
              class="bg-gray-800 rounded-2xl p-8 flex flex-col items-center border border-gray-700"
            >
              <h3 class="text-lg font-bold text-white mb-6">MotionTilt</h3>
              <MotionTilt
                :max-tilt="18"
                class="w-48 h-48 rounded-3xl bg-linear-to-br from-primary to-purple-600 flex items-center justify-center shadow-xl"
              >
                <UIcon name="i-lucide-move-3d" class="text-5xl text-white" />
              </MotionTilt>
            ...
            <div
              class="bg-gray-800 rounded-2xl p-8 flex flex-col items-center border border-gray-700"
            >
              <h3 class="text-lg font-bold text-white mb-6">MotionMagnetic</h3>
              ...
              <p class="text-gray-500 text-sm mt-6">Cursor proximity pulls the element toward it</p>
            </div>
          </div>

          <div class="bg-gray-950 rounded-2xl p-8 border border-gray-800">
            <div class="flex items-center justify-between mb-6 flex-wrap gap-4">
              <h3 class="text-lg font-bold text-white">MotionCursor</h3>
            ...
            <div
              class="h-56 rounded-2xl bg-gray-900 relative overflow-hidden flex items-center justify-center cursor-none"
            >
              <MotionCursor :type="cursorType" />
              <p class="text-gray-500">Move your mouse inside this box</p>
            </div>
          </div>
        </UContainer>
      </section>
      ...
      <section class="py-24 bg-gray-950 overflow-hidden">
        <UContainer>
          <div class="text-center mb-16">
            <h2 class="text-4xl md:text-5xl font-bold text-white mb-4">MotionVelocityEffect</h2>
            <p class="text-gray-400 text-lg">
          ...
          <MotionVelocityEffect
            ...
            class="text-center"
          >
            <h3 class="text-5xl md:text-7xl font-black text-white">SCROLL TO REACT</h3>
          </MotionVelocityEffect>
        </UContainer>
      </section>
        ...
        <UContainer>
          ...
          <MotionStaggered class="grid grid-cols-2 md:grid-cols-4 gap-4 mb-16" :stagger-delay="80">
            <div
              v-for="i in 8"
              :key="i"
              class="aspect-square rounded-2xl bg-linear-to-br from-gray-800 to-gray-900 border border-gray-700 flex items-center justify-center text-3xl font-bold text-white"
            >
              {{ i }}
            </div>
          </MotionStaggered>
          ...
          <div class="grid sm:grid-cols-3 gap-6 max-w-3xl mx-auto text-center">
            <div class="bg-gray-800 rounded-2xl p-8 border border-gray-700">
              ...
              <p class="text-gray-500 text-sm mt-2">TSL pipeline blocks</p>
            </div>
            <div class="bg-gray-800 rounded-2xl p-8 border border-gray-700">
              <p class="text-4xl font-black text-primary">
                <MotionCountUp :key="`b-${countKey}`" :to="21" />
              </p>
              <p class="text-gray-500 text-sm mt-2">Layers in the monorepo</p>
            </div>
            <div class="bg-gray-800 rounded-2xl p-8 border border-gray-700">
              <p class="text-4xl font-black text-primary">
                <MotionCountUp :key="`c-${countKey}`" :to="60" suffix="fps" />
              </p>
              <p class="text-gray-500 text-sm mt-2">Target frame rate</p>
            </div>
          </div>
