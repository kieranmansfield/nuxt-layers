  ...
  >
    <div class="bg-gray-950 min-h-screen">
        ...
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <section class="space-y-6">
            <div>
              ...
              <p class="text-gray-500">
                ...
                <code>&#x3C;?xml-stylesheet?&#x3E;</code> processing instruction. Open them directly
                in your browser for a styled reading experience — no RSS reader needed.
              </p>
            </div>
          ...
          <section class="space-y-6">
            <div>
              ...
              <p class="text-gray-500">
                Fetch a feed format directly from this server and inspect the output
              </p>
            </div>
                ...
                <div class="relative">
                  ...
                  <div v-else-if="previewContent">
                    ...
                    >
                      ...
                      >
                        <span
                          :class="previewFormat ? fmt(previewFormat).iconColor : 'text-gray-500'"
                        >
                      ...
                      <div
                        class="bg-gray-950 text-gray-100 p-4 font-mono text-xs overflow-x-auto max-h-96 overflow-y-auto"
                      >
              ...
              <div class="space-y-4">
                ...
                <div class="grid gap-4 md:grid-cols-2">
                  ...
                  <div class="p-4 bg-gray-50 dark:bg-gray-800 rounded-lg">
                    ...
                    <p class="text-sm text-gray-600 dark:text-gray-400">
                      5-minute browser cache, 1-hour CDN cache — safe for Netlify Edge, Cloudflare,
                      and Vercel
                    </p>
                  </div>
                </div>
            ...
            <UCard>
              ...
              <div class="space-y-4">
                <div class="grid gap-3 md:grid-cols-4 items-center">
                  ...
                  <div class="flex items-center justify-center">
                    <UIcon
                      ...
                      class="text-gray-400 text-xl hidden md:block"
                    />
                ...
                <div class="grid gap-3 md:grid-cols-3">
                  ...
                  >
                    <UIcon :name="config.icon" class="text-xl mb-2" :class="[config.iconColor]" />
      ...
      <DemoPageFooter
        ...
        :links="[
          { label: 'Content Layer', to: '/content', icon: 'i-lucide-file-text' },
