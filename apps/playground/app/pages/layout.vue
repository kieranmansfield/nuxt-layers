    ...
    <UContainer class="py-8">
      <div class="space-y-12">
        ...
        <div class="flex items-center gap-4">
          ...
          <div>
            <h1 class="text-3xl font-bold">Layout Layer</h1>
            <p class="text-gray-500 dark:text-gray-400">Grid system, sections, and page components</p>
          </div>
          <div class="ml-auto">
            <UButton
              variant="outline"
        ...
        <section class="space-y-8">
          ...
          <UCard>
            <template #header>
              ...
              <p class="text-sm text-gray-500 mt-1">Position content on the 18-column grid with responsive values</p>
            </template>

            <div class="space-y-6">
              <!-- Responsive Columns -->
              <div>
                <h4 class="text-sm font-medium uppercase tracking-wide text-gray-500 mb-3">Responsive Column Spans</h4>
                <div class="bg-gray-100 dark:bg-gray-800 rounded-lg p-4 space-y-2">
                  <div class="grid grid-cols-18 gap-1">
                    <div class="col-span-6 bg-blue-500/20 p-2 text-center text-xs rounded">6 cols (mobile)</div>
                    <div class="col-span-6 bg-blue-500/10 p-2 text-center text-xs rounded opacity-50">...</div>
                    <div class="col-span-6 bg-blue-500/10 p-2 text-center text-xs rounded opacity-50">...</div>
                  </div>
                  <div class="grid grid-cols-18 gap-1">
                    <div class="col-span-9 bg-green-500/20 p-2 text-center text-xs rounded">9 cols (tablet)</div>
                    <div class="col-span-9 bg-green-500/10 p-2 text-center text-xs rounded opacity-50">...</div>
                  </div>
                  <div class="grid grid-cols-18 gap-1">
                    <div class="col-span-12 bg-purple-500/20 p-2 text-center text-xs rounded">12 cols (desktop)</div>
                    <div class="col-span-6 bg-purple-500/10 p-2 text-center text-xs rounded opacity-50">...</div>
                  </div>
                </div>
              </div>
              ...
              <!-- Code Example -->
              <div>
                <h4 class="text-sm font-medium uppercase tracking-wide text-gray-500 mb-3">Usage Example</h4>
                <pre class="bg-gray-900 text-gray-100 p-4 rounded-lg text-sm overflow-x-auto"><code>&lt;LayoutGridItem
        ...
        <section class="space-y-8">
          ...
          <UCard>
            <template #header>
              ...
              <p class="text-sm text-gray-500 mt-1">Full-viewport hero section with background, content, and footer slots</p>
            </template>

            <div class="space-y-6">
              <!-- Visual Demo -->
              <div class="relative bg-gray-100 dark:bg-gray-800 rounded-lg overflow-hidden aspect-video">
                ...
                <div class="absolute inset-0 flex flex-col">
                  ...
                  <div class="p-4 text-center">
                    <div class="inline-block px-4 py-2 bg-primary/20 rounded text-sm">Footer Slot</div>
                  </div>
                </div>
              </div>
              ...
              <!-- Slots -->
              <div>
                <h4 class="text-sm font-medium uppercase tracking-wide text-gray-500 mb-3">Available Slots</h4>
                <div class="grid gap-3 md:grid-cols-3">
                  <div class="p-3 bg-gray-50 dark:bg-gray-800 rounded-lg">
                    <div class="font-mono text-sm text-primary">#background</div>
                    <p class="text-sm text-gray-500 mt-1">Full-bleed background layer (z-index: 0)</p>
                  </div>
                  <div class="p-3 bg-gray-50 dark:bg-gray-800 rounded-lg">
              ...
              <!-- Code Example -->
              <pre class="bg-gray-900 text-gray-100 p-4 rounded-lg text-sm overflow-x-auto"><code>&lt;LayoutSectionHero&gt;
  &lt;template #background&gt;
...
&lt;/LayoutSectionHero&gt;</code></pre>
          ...
          <UCard>
            <template #header>
              ...
              <p class="text-sm text-gray-500 mt-1">Two-column layout with optional mobile reversal</p>
            </template>
            ...
            <div class="space-y-6">
              ...
              <!-- Props -->
              <div>
                <h4 class="text-sm font-medium uppercase tracking-wide text-gray-500 mb-3">Props</h4>
              ...
              <!-- Code Example -->
              <pre class="bg-gray-900 text-gray-100 p-4 rounded-lg text-sm overflow-x-auto"><code>&lt;LayoutSectionSplit reverse&gt;
  &lt;template #left&gt;
...
&lt;/LayoutSectionSplit&gt;</code></pre>
          ...
          <UCard>
            <template #header>
              ...
              <p class="text-sm text-gray-500 mt-1">Auto-placing grid for collections with responsive columns</p>
            </template>
            ...
            <div class="space-y-6">
              ...
              <!-- Code Example -->
              <pre class="bg-gray-900 text-gray-100 p-4 rounded-lg text-sm overflow-x-auto"><code>&lt;LayoutSectionGallery :items="images" :columns="3"&gt;
        ...
        <section class="space-y-8">
          ...
          <UCard>
            <template #header>
              ...
              <p class="text-sm text-gray-500 mt-1">Unified page wrapper with SEO metadata and header</p>
            </template>
            ...
            <div class="space-y-6">
              ...
              <div class="grid gap-4 md:grid-cols-2">
                <div class="p-4 bg-gray-50 dark:bg-gray-800 rounded-lg">
                  ...
                  <p class="text-sm text-gray-500">Sets page title, meta description, and Open Graph tags via useHead()</p>
                </div>
                <div class="p-4 bg-gray-50 dark:bg-gray-800 rounded-lg">
                  <h4 class="font-medium mb-2">Grid Debug</h4>
                  <p class="text-sm text-gray-500">Includes LayoutGridDebug helper - toggle with Cmd/Ctrl + G</p>
                </div>
                <div class="p-4 bg-gray-50 dark:bg-gray-800 rounded-lg">
                  <h4 class="font-medium mb-2">Layout Modes</h4>
                  <p class="text-sm text-gray-500">Switch between 'grid' (Swiss Grid) and 'upage' (Nuxt UI) layouts</p>
                </div>
                <div class="p-4 bg-gray-50 dark:bg-gray-800 rounded-lg">
                  <h4 class="font-medium mb-2">Title Redundancy</h4>
                  <p class="text-sm text-gray-500">Provides title to children via Vue provide/inject</p>
                </div>
              </div>
                  ...
                  <table class="w-full text-sm">
                    ...
                    <tbody class="divide-y">
                      ...
                      <tr>
                        ...
                        <td class="py-2 px-3 font-mono text-xs">'hero' | 'centered' | 'fullWidth'</td>
              ...
              <!-- Code Example -->
              <pre class="bg-gray-900 text-gray-100 p-4 rounded-lg text-sm overflow-x-auto"><code>&lt;LayoutPageContainer
  title="About Us"
...
&lt;/LayoutPageContainer&gt;</code></pre>
        ...
        <div class="flex gap-4 justify-center pt-4">
          <UButton to="/ui" variant="outline" icon="i-lucide-arrow-left">
            UI Layer Demo
          </UButton>
