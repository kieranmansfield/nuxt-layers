                ...
                <UCard>
                  <template #header>
                    ...
                    <p class="text-sm text-muted mt-1">
                      ...
                      <code class="font-mono text-xs">&lt;main class="mastmain"&gt;</code> and owns
                      the stacking context. Drops the class when
                    ...
                    <div class="grid gap-3 sm:grid-cols-2">
                      ...
                      <div class="p-3 bg-elevated rounded-lg">
                        ...
                        <p class="text-xs text-muted mt-1">
                          max-width: 90rem — cards, media (default)
                        </p>
                      </div>
                      <div class="p-3 bg-elevated rounded-lg">
                        <div class="font-mono text-sm text-primary">'fluid'</div>
                      ...
                      <div class="p-3 bg-elevated rounded-lg">
                        ...
                        <p class="text-xs text-muted mt-1">
                          100vw — escapes gutters, true full-bleed
                        </p>
                      </div>
                    </div>
...
&lt;LayoutGridItem preset="content"&gt;Main&lt;/LayoutGridItem&gt;</code></pre>
                ...
                <UCard>
                  <template #header>
                    ...
                    <p class="text-sm text-muted mt-1">
                      Some presets are designed to be used together — they sum to 18 columns at lg
                      and stack to full-width on mobile. The bars below show both presets
                      simultaneously.
                    </p>
                  </template>
                    ...
                    <div v-for="pair in presetPairs" :key="pair.label" class="space-y-2">
                      ...
                      <div class="flex flex-wrap gap-4 text-xs text-muted">
                        ...
                        >
                          ...
                          <span
                            >lg: cols {{ part.lgStart }}–{{ part.lgStart + part.lgSpan - 1 }}</span
                          >
                        </div>
                      </div>
                    </div>
                ...
                <UCard>
                  ...
                  <div class="space-y-6">
                    <div class="relative bg-elevated rounded-lg overflow-hidden aspect-video">
                      <div
                        class="absolute inset-0 bg-linear-to-br from-blue-500/20 to-purple-500/20"
                      />
              ...
              <section class="space-y-8">
                ...
                <UCard>
                  <template #header>
                    ...
                    <p class="text-sm text-muted mt-1">
                      Named values from
                      <code class="font-mono text-xs">layoutLayer.ui.grid.layers</code> — override
                      any in app.config.ts
                    </p>
                  </template>
                  ...
                  <div class="space-y-4">
                    <div class="grid gap-3 sm:grid-cols-2">
                      <div class="p-3 bg-elevated rounded-lg">
                        ...
                        <p class="text-xs text-muted mt-1">
                          auto-fit, min <code class="font-mono">--fluid-col-min</code> (default
                          16rem)
                        </p>
                      </div>
                      <div class="p-3 bg-elevated rounded-lg">
...
&lt;/div&gt;</code></pre>
              ...
              <section class="space-y-8">
                <div>
                  ...
                  <p class="text-muted">
                    Debugging utilities — included automatically by LayoutPage
                  </p>
                </div>
              ...
              <section class="space-y-4">
                <div>
                  ...
                  <p class="text-muted">
                    Scroll-driven layout compositions built on the layout layer
                  </p>
                </div>
