  ...
  <div v-else class="h-full overflow-y-auto">
    ...
    >
      ...
      <div class="shrink-0 flex items-center gap-3 px-8 pt-8 pb-4">
        ...
        <span class="text-xs font-mono text-muted">{{ colour.hex }}</span>
      </div>
      ...
      <div class="shrink-0 border-t border-default bg-elevated px-8 py-6">
        <div class="flex items-start gap-10">
          <!-- Harmony type selector -->
          <div class="shrink-0">
            <label class="text-xs font-semibold text-muted uppercase tracking-wider block mb-2">
              Harmony
            </label>
            <USelect
